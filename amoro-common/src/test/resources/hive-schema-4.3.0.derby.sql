...
-- https://github.com/apache/hive/blob/master/standalone-metastore/metastore-server/src/main/sql/derby/hive-schema-4.3.0.derby.sql
--
...
CREATE TABLE HIVE_LOCKS (
  ...
  HL_CATALOG varchar(128) NOT NULL,
...
CREATE TABLE MATERIALIZATION_REBUILD_LOCKS (
  ...
  MRL_CAT_NAME VARCHAR(128) NOT NULL,
...
-- -----------------------------------------------------------------
INSERT INTO "APP"."VERSION" (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '4.3.0', 'Hive release version 4.3.0');
