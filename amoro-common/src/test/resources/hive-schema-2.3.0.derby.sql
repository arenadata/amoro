...
-- https://github.com/apache/hive/blob/rel/release-2.3.10/metastore/scripts/upgrade/derby/hive-schema-2.3.0.derby.sql
--
...
-- inlined from 022-HIVE-11107.derby.sql (the RUN directive is an ij command,
-- not SQL, and this schema is executed statement by statement over JDBC)
...
-- ----------------------------
-- inlined from hive-txn-schema-2.3.0.derby.sql
CREATE TABLE TXNS (
