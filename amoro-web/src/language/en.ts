...
export default {
  ...
  cancelCleanupProcessOptModalTitle: 'Cancel the cleanup process of this table?',
  cancelProfilingProcessOptModalTitle: 'Cancel the profiling process of this table?',
  ...
  subModule: 'SubModule',
  healthScoreDescription: 'Evaluating the health status of a table (up to 100 points), and is calculated as follows',
  smallFileScoreDescription: 'Evaluating the average data file size of the table (up to 40 points), with larger values indicating that the file is closer to the target size',
  equalityDeleteScoreDescription: 'Evaluating the table\'s equality delete records ratio (up to 40 points), with larger values indicating a lower percentage of equality delete records',
  positionalDeleteScoreDescription: 'Evaluating the table\'s positional delete records ratio (up to 20 points), with larger values indicating a lower percentage of positional delete records',
}
