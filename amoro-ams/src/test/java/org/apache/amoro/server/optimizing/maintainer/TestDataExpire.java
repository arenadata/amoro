...
public class TestDataExpire extends ExecutorTestBase {
  ...
  public static Object[] parameters() {
    return new Object[][] {
      ...
      {
        new BasicCatalogTestHelper(TableFormat.MIXED_ICEBERG),
        new BasicTableTestHelper(TABLE_SCHEMA3, PRIMARY_KEY_SPEC, SPEC4, getDefaultProp())
      },
      {
        new BasicCatalogTestHelper(TableFormat.MIXED_ICEBERG),
        new BasicTableTestHelper(
      ...
      },
      {
        new BasicCatalogTestHelper(TableFormat.MIXED_ICEBERG),
        new BasicTableTestHelper(
            TABLE_SCHEMA3, PrimaryKeySpec.noPrimaryKey(), SPEC4, getDefaultProp())
      },
      {
        new BasicCatalogTestHelper(TableFormat.MIXED_ICEBERG),
        new BasicTableTestHelper(
  ...
  private void testKeyedPartitionLevel() {
    ...
    MixedTableMaintainer tableMaintainer =
        new MixedTableMaintainer(keyedTable, TestTableMaintainerContext.of(keyedTable));
  ...
  public void testBaseOnRule() {
    ...
    if (getTestFormat().equals(TableFormat.ICEBERG)) {
      ...
      MixedTableMaintainer mixedTableMaintainer =
          new MixedTableMaintainer(mixedTable, TestTableMaintainerContext.of(mixedTable));
